...
$tests[] = array('name' => 'Namepace Loop',
                 ...
                 'realistic' => dirname(__FILE__) . '/data/');
...
$tests[] = array('name' => 'Recursion 1',
                 ...
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/fnd-pf-pf-pf-ns-output',
                 'realistic' => dirname(__FILE__) . '/data/');
/*
...
$tests[] = array('name' => 'Namespace loops',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/loopx',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/loopx-output1',
                 'realistic' => dirname(__FILE__) . '/data/');
...
$tests[] = array('name' => 'Namespace loops',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/loopx',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/loopx-output2',
                 'realistic' => dirname(__FILE__) . '/data/');
...
$tests[] = array('name' => 'Namespace loops',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/loopx',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/loopx-output3',
                 'realistic' => dirname(__FILE__) . '/data/');
/*
...
$tests[] = array('name' => 'Namespace loops',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/loopx',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/loopx-output',
                 'realistic' => dirname(__FILE__) . '/data/');
...
$tests[] = array('name' => 'HTML document with transformation attribute on root',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/html-and-grddl-xform-attr',
...
$tests[] = array('name' => ' Content Negotation with GRDDL (3 of 3)',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/conneg.html',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/conneg-output',
                 'realistic' => dirname(__FILE__) . '/data/');
/*
...
$tests[] = array('name' => 'Multiple Representations (HTML)',
                 ...
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/multipleRepresentationsHtml-output',
                 'realistic' => dirname(__FILE__) . '/data/');
/*
...
$tests[] = array('name' => 'Multiple Representations (SVG)',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/multipleRepresentations',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/multipleRepresentationsSvg-output',
                 'realistic' => dirname(__FILE__) . '/data/');
/*
...
$tests[] = array('name' => 'Multiple Representations (both)',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/multipleRepresentations',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/multipleRepresentationsBoth-output',
                 'realistic' => dirname(__FILE__) . '/data/');


$tests[] = array('name' => 'An html document with a base element',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/base/xhtmlWithBaseElement',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/xhtmlWithBaseElement-output',
                 'realistic' => dirname(__FILE__) . '/data/');

$tests[] = array('name' => 'A similar html document without a base element',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/base/xhtmlWithoutBaseElement',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/xhtmlWithoutBaseElement-output',
                 'realistic' => dirname(__FILE__) . '/data/');

$tests[] = array('name' => 'A redirected html document with a base element',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/xhtmlWithBaseElement',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/xhtmlWithBaseElement-output',
                 'realistic' => dirname(__FILE__) . '/data/');

$tests[] = array('name' => 'A similar redirected html document without a base element',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/xhtmlWithoutBaseElement',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/xhtmlWithoutBaseElement-output',
                 'realistic' => dirname(__FILE__) . '/data/');
...
$tests[] = array('name' => ' An xml document with an xml:base attribute',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/base/xmlWithBase',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/xmlWithBase-output',
                 'realistic' => dirname(__FILE__) . '/data/');
/*
...
$tests[] = array('name' => 'A similar xml document without an xml:base attribute',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/base/xmlWithoutBase',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/xmlWithoutBase-output',
                 'realistic' => dirname(__FILE__) . '/data/');
/*
...
$tests[] = array('name' => 'A redirected xml document with an xml:base attribute',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/xmlWithBase',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/xmlWithBase-output',
                 'realistic' => dirname(__FILE__) . '/data/');
/*
...
$tests[] = array('name' => 'A similar redirected xml document without an xml:base attribute',
                 'in' => 'http://www.w3.org/2001/sw/grddl-wg/td/xmlWithoutBase',
                 'out' => 'http://www.w3.org/2001/sw/grddl-wg/td/xmlWithoutBase-output',
                 'realistic' => dirname(__FILE__) . '/data/');
